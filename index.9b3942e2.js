...
})({"jDgAY":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "80890de79b3942e2";
"use strict";
...
(0, _jqueryDefault.default)(document).ready(function() {
    (0, _jqueryDefault.default)(".theme-toggle").on("click", function() {
        (0, _jqueryDefault.default)("body").toggleClass("dark-theme");
    });
});
...
function changeStep() {
    ...
    (0, _jqueryDefault.default)(stepId).addClass("step_active");
    setTimeout(function() {
...
function runTimer(f) {
    ...
    let countdown = setInterval(function() {
        if (exercisesStatus === "started") {
            ...
            if (left >= 0) {
                if (left > 9) (0, _jqueryDefault.default)(".exercise_active .time").text("00:" + left);
                else (0, _jqueryDefault.default)(".exercise_active .time").text("00:0" + left);
            } else {
            ...
            clearInterval(countdown);
            if (exercise === "tense") (0, _jqueryDefault.default)(".exercise_active .time").text("00:05");
            else (0, _jqueryDefault.default)(".exercise_active .time").text("00:00");
        }
    }, 1000);
}
function runTense() {
    exercise = "tense";
    timer = 5000;
    (0, _jqueryDefault.default)(stepId + " .tense").addClass("exercise_active");
    runTimer(function() {
        (0, _jqueryDefault.default)(stepId + " .tense").removeClass("exercise_active");
        runRelax();
    });
}
function runRelax() {
    exercise = "relax";
    timer = 15000;
    (0, _jqueryDefault.default)(stepId + " .relax").addClass("exercise_active");
    runTimer(function() {
        (0, _jqueryDefault.default)(stepId + " .relax").removeClass("exercise_active");
        (0, _jqueryDefault.default)(stepId).removeClass("step_active");
        currentStep++;
        changeStep();
...
function endExercises() {
    (0, _jqueryDefault.default)(".button").hide();
    (0, _jqueryDefault.default)(".button").removeClass("pause");
    (0, _jqueryDefault.default)(".button").text("\u041D\u0430\u0447\u0430\u0442\u044C \u0437\u0430\u043D\u043E\u0432\u043E");
    (0, _jqueryDefault.default)(".button").fadeIn();
...
function programTrigger() {
    if (exercisesStatus === "waiting" || exercisesStatus === "pause") {
        (0, _jqueryDefault.default)(".button").hide();
        (0, _jqueryDefault.default)(".button").addClass("pause");
        (0, _jqueryDefault.default)(".button").text("\u041F\u0430\u0443\u0437\u0430");
        (0, _jqueryDefault.default)(".button").fadeIn();
        startExercises();
    } else if (exercisesStatus === "started") {
        (0, _jqueryDefault.default)(".button").hide();
        (0, _jqueryDefault.default)(".button").removeClass("pause");
        (0, _jqueryDefault.default)(".button").text("\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0438\u0442\u044C");
        (0, _jqueryDefault.default)(".button").fadeIn();
...
},{}]},["jDgAY","8ZNvh"], "8ZNvh", "parcelRequirea937")

//# sourceMappingURL=index.9b3942e2.js.map
